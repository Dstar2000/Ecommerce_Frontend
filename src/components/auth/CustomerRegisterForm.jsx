...
export default function CustomerRegisterForm() {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-white">
      {/* LEFT INFO SECTION */}
      <div className="hidden md:flex flex-col justify-center px-16 bg-gradient-to-br from-gray-900 to-black text-white">
        <div className="max-w-md">
          <h1 className="text-4xl font-bold mb-4">Create your account</h1>
          <p className="text-gray-300 text-lg leading-relaxed">
            Register as a customer to explore products, place orders, and manage
      ...
      <div className="flex items-center justify-center px-6">
        <div className="w-full max-w-md">
          <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-10">
            ...
            <p className="text-gray-500 mb-8">Create your customer account</p>
